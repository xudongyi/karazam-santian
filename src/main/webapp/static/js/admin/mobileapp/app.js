...
$(function () {
    appDg = $('#appDg').datagrid({
        ...
        columns: [[
            ...
            {field: 'appType', title: '类型', width: 300, height:300},
            {field: 'versionName', title: '版本名称', width: 300,height:300},
            {field: 'versionNo', title: '版本号', width: 300,height:300},
            {field: 'packageName', title: '包名', width: 300,height:300},
            {field: 'appUrl', title: '下载地址', width: 300,height:300,
...
function createApp() {
    appDialog = Keasy.dialog({
        ...
        width: 600,
        height: 480,
        href: ctx + '/admin/mobileapp/create',
        maximizable: true,
        modal: true
    });
}
...
function updateApp() {
    ...
    appDialog = Keasy.dialog({
        ...
        width: 600,
        height: 480,
        href: ctx + '/admin/mobileapp/update/' + row.id,
        maximizable: true,
        modal: true
    });
}
...
function doConfirmDialog(formData) {
    ...
    if ('create' == action) {
        Keasy.post("/admin/mobileapp/create", formData, function (data) {
        ...
        Keasy.put("/admin/mobileapp/update", formData, function (data) {
            successTip(data, appDg, appDialog);
        })
    }
}
        ...
        $.ajaxFileUpload({
            ...
            success: function (data, status) {
                ...
                if (data.status == 'success') {
                    ...
                    console.log(data.data.attachUrl);
                    uploadDg.dialog('destroy');
                }
            },
