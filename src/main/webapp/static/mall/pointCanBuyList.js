...
!function t(e, n, i) {
    ...
    "1": [function (t, e, n) {
        ...
        window.AeroDialog = {
            ...
            function e(t, e, n) {
                return ['<div class="AeroWindow">',
                    ...
                    '<div class="titles winBtns"><span class="title">',
                    t,
                    "</span>",
                    e,
                    "</div>",
                    '<div class="tb-mm-container">',
                    n,
                    "</div>",
                    "</div></div>"].join("")
            }
        ...
        var i = function (t, e) {
            var n = [];
            t("[role=navigation]").attr("un-id") ? t.when(t.get("members_point_favorites.json?page=1&pageSize=99999999")).then(function (t) {
        ...
        a($, function (t) {
            new i({"apiurl": "pointCanBuy.json", "filter": {"psort": 4, "page": 1, "pageSize": 16}, "myFavorites": t})
        })
    }, {"../common/getMyFavorites": 4, "../products/product_list.js": 6}], "6": [function (t, e, n) {
        "use strict";
        function i(e) {
            this.opts = $.extend({
                "apiurl": "/mall/api/v2/product/list",
                "filter": {"cid1": "0B115B4C-B7E2-4BBD-B944-6F5CDFB62A3D", "cid2": "", "ev": "", "psort": 1, "page": 1, "pageSize": 16},
                "myFavorites": [],
        ...
        t("../../plugins/jquery.page.js"),
            t("../../plugins/lazy.loadjs.js"),
            t("../../plugins/jquery.aerowindow"),
            ...
            $.when($.get(t.opts.apiurl, t.opts.filter)).then(function (e) {
                ...
                if (e.data && e.data.results) {
                    ...
                    for (var i = e.data.results, a = [], r = 0; r < i.length; r++) {
                        var s = {};
                        s.id = i[r].id,
                            s.url = redirect.mall("/products/detail/" + i[r].id),
                            s.imgUrl = i[r].images.length > 0 ? i[r].images[0] : "",
                            s.name = i[r].name,
                            s.price = i[r].pointsNeeded,
                            s.leftCount = i[r].inventory,
                            s.desc = i[r].briefProduct || "",
                            s.isFavorited = _.contains(t.opts.myFavorites, i[r].id),
                            a.push(s)
                    }
                    var o = '<p class="nodata"><i class="bg"></i>未找到商品！</p>';
                    t.opts.$listContainer.html(a.length > 0 ? dotRender(t.opts.tpl, a) : o),
                        t.opts.$currentPage.html(t.opts.filter.page),
                        t.opts.$totalCount.html(n),
                        t.opts.$totalPage.html(Math.ceil(n / t.opts.filter.pageSize)),
                        $(".my-points .mynum").html(n),
                        Math.ceil(n / t.opts.filter.pageSize) > 1 ? t.opts.$pageBar.show() : t.opts.$pageBar.hide(),
                        t.pageBar ? t.pageBar.reset({
            ...
            $(".classify .item").hover(function () {
                ...
                $(this).hasClass("current") || ($(this).addClass("current").siblings().removeClass("current"),
                    $(".classify-bottom-line").css("left", 200 * $(this).index()),
                    e = 200 * $(this).index(),
                    t.opts.filter.cid2 = $(this).attr("data-id"),
                    t.renderList())
                ...
                if ($(this).hasClass("by-point") || !$(this).hasClass("current")) {
                    ...
                    $(this).hasClass("by-point") ? (i = 4 == n ? 5 : 4, $(this).attr("data-type", i)) : $(".by-point").attr("data-type", ""),
                        t.opts.filter.page = 1,
                        t.opts.filter.psort = i, t.renderList()
                }
                ...
                n.hasClass("orange") ? $.when($.post("favorites.json")).then(function (e) {
                    e.success ? (showFocusTip(n.parent().find(".focus-tip"), "取消关注"),
                        n.removeClass("fa-heart orange").addClass("fa-heart-o"),
                        n.attr("title", "加关注"),
                        t.opts.myFavorites = _.without(t.opts.myFavorites, i)) : showFocusTip(n.parent().find(".focus-tip"),
                        "取消关注失败")
                }) : $.when($.post("favorites.json")).then(function (e) {
                    e.success ? (showFocusTip(n.parent().find(".focus-tip"), "关注成功"),
                        n.removeClass("fa-heart-o").addClass("fa-heart orange"),
                        n.attr("title", "已关注"),
                        t.opts.myFavorites.push(i)) : showFocusTip(n.parent().find(".focus-tip"), "关注失败")
                })
        ...
        e.exports = '{%~it:item:index%}\n' +
            ...
            '</div>\n    ' +
            '<div class="buy">' +
            '<a href={%=item.url%} class="orange">立即换购</a>' +
            '</div>\n  ' +
            '</div>\n' +
            '</div>\n{%~%}'
    }, {}]
