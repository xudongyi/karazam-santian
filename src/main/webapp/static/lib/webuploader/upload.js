...
(function ($, window) {
    ...
    function initWebUpload(item, options) {
        ...
        var webuploaderoptions = $.extend({
                ...
                // swf文件路径
                swf: ctx + '/static/lib/webuploader/Uploader.swf',
                // 文件接收服务端。
                server:  '/Home/AddFile',
    ...
    $.fn.powerWebUpload = function (options) {
        ...
        if (typeof WebUploader == 'undefined') {
            var casspath = ctx + "/static/lib/webuploader/webuploader.css";
            $("<link>").attr({ rel: "stylesheet", type: "text/css", href: casspath }).appendTo("head");
            var jspath = ctx + "/static/lib/webuploader/webuploader.min.js";
