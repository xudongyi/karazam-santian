[#-- {{{"use":"category","name":"about","des":"关于我们"}}} --]
[@nestedstyle]
    ...
    [@css href="css/article/about.css" /]
    [@css href="css/skins/default.css" /]
[/@nestedstyle]
[@nestedscript]
    [@js src="js/posts/category/about.js" /]
[/@nestedscript]
...
<div class="container issue-container">
    <div class="row">
        <article class="col-md-12 info-list">
            ...
            <div class="pageList pull-right" id="pagination" style="text-align: right; margin-top: 5px; margin-right: 30px;"></div>
        </article>
    </div>
</div>
            ...
            <div class="issue-ever">
                ...
                {{# }else{ }}
                    [#--<div class="issue-list-title">--]
                        ...
                        [#--</span>--]
                    [#--</div>--]
                    [#--<small class="muted" style="">{{item.createDate}}</small>--]
                    {{# CMS.addViewCount(item.id) }}
                    <p style=""> {{item.text}}</p>
                {{# } }}
            </div>
        </section>
