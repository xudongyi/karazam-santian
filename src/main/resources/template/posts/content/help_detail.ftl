[#-- {{{"use":"content","name":"help_detail","des":"帮助中心详情"}}} --]
[@nestedstyle]
...
[/@nestedstyle]
[@nestedscript]
    [@js src="js/posts/content/help.detail.js" /]
[/@nestedscript]
[@insert template="layout/content_layout" title="帮助中心" metaKey=content.metaKeywords metaDes=content.metaDescription currentUser=kuser user=kuser]
