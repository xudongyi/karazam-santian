	        ...
	        [#list investments as invest]
	        	<tr>
					...
					[#else]
						...
						[/#if]
					[/#if]
                    <td align="left" style="border-color: #ccc; border-style: solid; padding-left: 10px; border-width: 0 1px 1px 0;">${invest.amount?string("currency")}</td>
                    <td align="left" style="border-color: #ccc; border-style: solid; padding-left: 10px; border-width: 0 1px 1px 0;">${(borrowing.period)!"XX"}${borrowing.periodUnitDes}</td>
                    ...
                    <td align="left" style="border-color: #ccc; border-style: solid; padding-left: 10px; border-width: 0 1px 1px 0;">${(invest.planIncome)?string("currency")}</td>
	            </tr>
	        [/#list]
	    [#else]
        	<tr>
