...
<p style="text-align:right;">
    合同编号：<span>HSJR-${((investment.createDate)?string("yyyyMMdd"))!"XXXXXXXX"}-${(borrowing.id)!"XXXX"}[#---${(recovery.id)!"XXXX"}--]</span>
</p>
...
<br/>
    [#if investment.investorCrop?? && investment.investorCrop]
        <p>应收账款受让人：<span style="text-decoration:underline">${(investment.investorCorporationName)!"XXX"}</span><span>（以下简称乙方）</span></p>
        <p>营业执照 &nbsp;：<span></span>${(investment.investorCorporationIdCard)!"XXXXXX XXXXXXXX XXXX"}</p>
    [#else]
        <p>应收账款受让人：<span style="text-decoration:underline">${(investment.investorRealName)!"XXX"}</span><span>（以下简称乙方）</span></p>
...
<h4>第四条  融资金额及收益率</h4>
<p class="p" style="text-indent:2em;">本合同项下甲方转让应收账款进行融资的金额为人民币<span style="text-decoration:underline">&nbsp;&nbsp;${numToRMB(investment.amount)!"￥XXXX.XX"}&nbsp;&nbsp;</span>元整（<span style="text-decoration:underline">&nbsp;&nbsp;${(investment.amount?string("currency"))!"￥XXXX.XX"}&nbsp;&nbsp;</span>），预期年化收益率为<span style="text-decoration:underline">&nbsp;&nbsp;${(borrowing.realInterestRate)!"XX.XX"}%&nbsp;&nbsp;</span>。</p>
<h4>第五条  支付方式</h4>
...
<h4>第十七条  日期</h4>
<p class="p" style="text-indent:2em;">本合同中所有涉及的发生日、回购日等日期若恰为非银行营业日，则顺延至下一个最近的银行营业日。</p>
<h4>第十八条  争议解决</h4>
...
<p class="p" style="text-indent:2em;"><span width="100%">甲方：<span style="color: #8f8f8f;">（公章）</span></span>
    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
    <span>乙方：${(investment.investorLoginName)!"XXX"}</span></p>
<br/>
<p class="p" style="text-indent:2em;"><span>法定代表人（或授权委托人）：<span style="color: #8f8f8f;">（签印）</span></span></p>
<br/>
<p class="p" style="text-indent:2em;"><span style="margin-left: 600px;">签署日期：${(investment.createDate?string("yyyy年MM月dd日"))!"XXXX年XX月XX日"}</span></p>
<h4>附件1：还款计划列表 </h4>
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size: 12px; line-height: 36px;">
    <tr>
        <td align="center" style="border: 1px solid #ccc; padding-right: 10px;">还款期数</td>
        <td align="center" style="border-color: #ccc; border-style: solid; padding-left: 10px; border-width: 1px 1px 1px 0px;">还款时间</td>
        <td align="center" style="border-color: #ccc; border-style: solid; padding-left: 10px; border-width: 1px 1px 1px 0px;">还款利率（年利率）</td>
        <td align="center" style="border-color: #ccc; border-style: solid; padding-left: 10px; border-width: 1px 1px 1px 0px;">还款本金（人民币）</td>
        <td align="center" style="border-color: #ccc; border-style: solid; padding-left: 10px; border-width: 1px 1px 1px 0px;">还款利息（人民币）</td>
        <td align="center" style="border-color: #ccc; border-style: solid; padding-left: 10px; border-width: 1px 1px 1px 0px;">还款本息（人民币）</td>
    </tr>
    [#if repaymentPlans != null && repaymentPlans?size gt 0]
        [#list repaymentPlans as repaymentPlan]
            <tr>
                <td align="center" style="border-color: #ccc; border-style: solid; padding-right: 10px; border-width: 0px 1px 1px;">第${repaymentPlan.repaymentRecordPeriod}期/共${borrowing.period}期</td>
...
<table width="100%" border="0" cellpadding="0" cellspacing="0" style="font-size: 12px; line-height: 36px;">
    ...
    [#if investments != null && investments?size gt 0]
        ...
        [#list investments as invest]
            <tr>
                <td align="left" style="border-color: #ccc; border-style: solid; padding-left: 10px; border-width: 0px 1px 1px;">${secrecy("mobile",investment.investorLoginName)!recovery.investor.corpName}</td>
