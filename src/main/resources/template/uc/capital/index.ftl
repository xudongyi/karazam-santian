[@nestedscript]
    [@js src="js/user/user.capital.js" /]
[/@nestedscript]
...
<script id="capitalTpl" type="text/html">
    {{#  $.each(d.rows, function(index, item){ }}
        <ul class="content">
            ...
            <li class="tar" style="width:17%;">{{ item.methodDes }}</li>
            <li class="tar" style="width:17%;">{{ currency(item.amount, '￥') }}</li>
            <li class="tar" style="width:21%;">{{ currency(item.fee, '￥') }}</li>
            <li class="tar" style="width:13%;">成功</li>
            <li class="detail tar" style="width: 14%;box-sizing:border-box;padding-right:1%;+width:10%;">
                ...
                <div class="zichan-detail have-more zichan-detail-{{ index }}"><i></i>
                    ...
                    <p>
                        ...
                        <span class="fr">{{ item.methodDes }}</span>
                    </p>
                    <p>
                        <span class="fl jine-name">{{ item.typeDes }}</span>
...
<script id="rechargeTpl" type="text/html">
    {{#  $.each(d.rows, function(index, item){ }}
        <ul class="content">
            <li class="tal" style="width:20%;">{{ item.createDate }}</li>
            ...
            <li class="tar" style="width:20%; padding-right: 20px;">{{ item.statusDes }}</li>
        </ul>
    {{#  }); }}
...
<script id="withdrawTpl" type="text/html">
    {{#  $.each(d.rows, function(index, item){ }}
        <ul class="content">
            <li class="tal" style="width:25%;">{{ item.createDate }}</li>
            <li class="tar" style="width:20%;">{{ currency(item.amount, '￥') }}</li>
            <li class="tar" style="width:20%;">{{ currency(item.fee, '￥') }}</li>
            <li class="tar" style="width:20%;">{{ currency(item.actualAmount, '￥') }}</li>
            <li style="width:15%;">{{ item.statusDes }}</li>
        </ul>
    {{#  }); }}
