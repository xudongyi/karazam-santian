[@nestedscript]
    [@js src="js/admin/posts/taxonomy.feature.js" /]
    [@js src="js/admin/posts/taxonomy.common.js" /]
[/@nestedscript]
[@insert template="admin/layout/default_layout" title="专题管理"]
<div class="easyui-layout" data-options="fit: true">
    <div data-options="region:'west',split:true,collapsible:false,border:false,title:'专题'" style="width: 400px;">
    ...
    <div data-options="region:'center',split:true,border:false,title:'专题列表'" style="width: 300px;">
        <div id="taxonomyBar">
