    ...
    <form [#--action="${ctx}/admin/goods_category/${action}"--] method="POST">
        ...
        <table id="basicInfo" class="tbform">
            ...
            <tr>
                <td>描述：</td>
                <td>
                    <textarea  id="seoDescription" type="" name="seoDescription" value="" class="easyui-validatebox" data-options="validType:'maxLength[200]'">${goodsCategory.seoDescription}</textarea>
                </td>
            </tr>
        </table>
    </form>
