[#--借款 回款计划--]
<table class="easyui-datagrid" data-options="data:${repaymentPlans},height:460">
    <thead>
    <tr>
        <th data-options="field:'id',width:100">回款计划编号</th>
        <th data-options="field:'repayment',width:100">还款编号</th>
        <th data-options="field:'borrowing',width:100">借款编号</th>
        ...
        <th data-options="field:'repaymentRecordPeriod',width:100">期数</th>
        ...
        <th data-options="field:'paidDateDes',width:100">实际回款日期</th>
