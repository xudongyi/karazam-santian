[@insert template="admin/layout/default_layout" title="借款审批"]
<div>
            ...
            <div title="审批意见">
                <table class="tbform">
                    <tr>
                        <td>审批状态：</td>
                        <td>
                            <select name="state" class="easyui-combobox" data-options="editable:false">
                                <option value="WAIT">待下次审批</option>
                                <option value="SUCCESS">审批已通过</option>
                                <option value="FAILURE">审批未通过</option>
                            </select>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td>是否推荐：</td>
                        <td>
                            <select name="isRecommend" value="${borrowing.isRecommend}" class="easyui-combobox" data-options="required:'required'">
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
        ...
        $(".approvalDisabledElement").attr("readonly", "readonly"); //禁用
    });
