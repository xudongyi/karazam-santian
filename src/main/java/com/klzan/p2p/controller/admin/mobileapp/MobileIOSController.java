 ...
 */
@Controller
@RequestMapping("/admin/mobileios")
public class MobileIOSController extends BaseController {
    ...
    public String index(Model model) {
        return "/admin/mobileios/index";
    }

    @RequestMapping(value = "json", method = RequestMethod.GET)
    @ResponseBody
    public Object json(PageCriteria criteria) {
        PageResult<MobileAppVo> page = mobileAppService.findByPage(criteria, DeviceType.IOS);
    ...
    public String createIndex(Model model) {
        ...
        return "/admin/mobileios/form";
    }

    @RequestMapping(value = "create", method = RequestMethod.POST)
    @ResponseBody
    public Result create(MobileAppVo vo) {
        vo.setAppType(DeviceType.IOS.name());
