...
public abstract class BaseDirective implements TemplateDirectiveModel {
    ...
    protected String getParam(String paramName, Map<String, TemplateModel> params) throws TemplateModelException {
        return FreemarkerUtils.getParameter(paramName, String.class, params);
    }
