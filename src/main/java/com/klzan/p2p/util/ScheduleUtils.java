...
public class ScheduleUtils {
    ...
    public static CronTrigger getCronTrigger(Scheduler scheduler, Integer jobId) {
        try {
            ...
            throw new BusinessProcessException("获取定时任务CronTrigger出现异常", e);
        }
    }
    ...
    public static void createScheduleJob(Scheduler scheduler, ScheduleJob scheduleJob) {
        try {
            ...
            throw new BusinessProcessException("创建定时任务失败", e);
        }
    }
    ...
    public static void updateScheduleJob(Scheduler scheduler, ScheduleJob scheduleJob) {
        try {
            ...
            throw new BusinessProcessException("更新定时任务失败", e);
        }
    }
    ...
    public static void run(Scheduler scheduler, ScheduleJob scheduleJob) {
        try {
            ...
            throw new BusinessProcessException("立即执行定时任务失败", e);
        }
    }
    ...
    public static void pauseJob(Scheduler scheduler, Integer jobId) {
        try {
            ...
            throw new BusinessProcessException("暂停定时任务失败", e);
        }
    }
    ...
    public static void deleteScheduleJob(Scheduler scheduler, Integer jobId) {
        try {
            ...
            throw new BusinessProcessException("删除定时任务失败", e);
        }
    }
}
