...
public class Page<E> extends ArrayList<E> {
     ...
     * @return
     */
    public PageResult<E> toPageInfo() {
        PageResult<E> pageInfo = new PageResult<>(this);
        return pageInfo;
    }
    ...
    public <E> PageResult<E> doSelectPageInfo(ISelect select) {
        select.doSelect();
        return (PageResult<E>) this.toPageInfo();
    }
