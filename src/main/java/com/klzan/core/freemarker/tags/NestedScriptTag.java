...
public class NestedScriptTag extends TagSupport implements TemplateDirectiveModel {
	...
	public void execute(Environment env, Map params, TemplateModel[] loopVars, TemplateDirectiveBody body) throws TemplateException, IOException {
		...
		requestContextHolder.getModel().put(TagName.SCRIPT.getTagName(), new ScriptTag(nestedContent));
	}
}
