...
public class DigestUtils {
    ...
    private static final org.slf4j.Logger LOGGER = LoggerFactory.getLogger(DigestUtils.class);
    private final static String key = "2206fb931cd62498e27817ef3649c09c";
     ...
     * 对文件进行md5散列.
     */
    public static byte[] makeMd5(InputStream input) throws IOException {
