...
import com.klzan.core.CommonAttrs;
import com.klzan.core.EnumConverter;
...
public final class FreemarkerUtils {
    ...
    public static String renderToString(Template ftl, Object retValue) throws TemplateException, IOException {
        ByteArrayOutputStream baos = null;
        Writer out = null;
        try {
            baos = new ByteArrayOutputStream();
            out = new OutputStreamWriter(baos, PlatformConstant.DEFAULT_CHARSET);
            ftl.process(retValue, out);
            out.flush();
            return baos.toString(PlatformConstant.DEFAULT_ENCODING);
        } finally {
    ...
    public static String parseWriteBodyToString(TemplateDirectiveBody body) throws IOException, TemplateException {
