...
public class ImageUtils {
    ...
    public static void resize(File srcFile, File destFile, int width,
        ...
        if (destFile.exists()) {
            ...
            FileUtils.createDir(destFile.getParent());
        }
        InputStream input = null;
    ...
    public static void crop(File source, File target, int x, int y, int w, int h) throws Exception {
        ...
        try {
            ...
            if (target.exists()) {
                ...
                FileUtils.createDir(target.getParent());
            }
    ...
    public static void makeRoundedCorner(File srcFile, File destFile, int cornerRadius) throws Exception {
        ...
        try {
            ...
            FileUtils.createDir(destFile.getParentFile().getAbsolutePath());
     ...
     */
    public static void imgCut(File srcImageFile, int x, int y, int desWidth,
                              int desHeight) {
